...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.cursor/commands/apm-8-delegate-debug.md or .cursor/commands/apm-7-delegate-research.md)]
```
